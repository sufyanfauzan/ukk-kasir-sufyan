    ...
    <div class="overflow-x-auto mt-8">
        ...
        @if (Auth::user()->role === 'admin')
            <div class="flex justify-end mb-4">
                <a href="{{ route('products.exportProducts') }}" class="btn btn-success text-white">Export</a>
                    ...
                    <tr>
                            ...
                            <div class="flex items-center gap-3">
                                <div class="avatar">
                                    <div class="mask mask-squircle h-24 w-24">
                                        <img src="{{ URL('storage/products/' . $item->image) }}" alt="photo" />
                                    </div>
                                </div>
                        </td>
                        <td>{{ $item->name }}</td>
                        ...
                        <th>
                            ...
                            <div id="modal_delete_{{ $item['id'] }}" class="modal">
                                <div class="modal-box">
                                    <h3 class="text-lg">HAPUS PRODUK</h3>
